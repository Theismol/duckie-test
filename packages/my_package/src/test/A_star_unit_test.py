...
class TestAStar(unittest.TestCase):
    ...
    def test_astar_found_path(self):
    ...
    def test_astar_no_path(self):
        ...
        # For instance, remove connections or add obstacles that block the path
        # Then test if the function returns None for both path and cost
        modified_graph = {
    (0, 0): {},
    (0, 1): {},
    (0, 2): {},
