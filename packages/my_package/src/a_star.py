...
def get_directions(path):
    ...
    for direction in directions_relative_to_grid:
        if direction == current_direction:
            directions_relative_to_duck.append("f")
            ...
            directions_relative_to_duck.append("l")
            ...
            directions_relative_to_duck.append("r")
            current_direction = direction
    for i in range(len(path) - 1):
        directions_dict[path[i]] = directions_relative_to_duck[i]
